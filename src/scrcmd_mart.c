...
const u16 _020FBA5A[] = { ITEM_BUBBLE_MAIL, ITEM_DIVE_BALL, ITEM_QUICK_BALL, 0xFFFF };
...
const u16 _020FBA68[] = { ITEM_AIR_MAIL, ITEM_TUNNEL_MAIL, ITEM_BLOOM_MAIL, ITEM_BRICK_MAIL, ITEM_MOSAIC_MAIL, 0xFFFF };
